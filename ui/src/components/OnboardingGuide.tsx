  ...
  return [
    {
      ...
      image: `/ui/mtx/assets/Onboarding/${theme}/ON_BOARDING_WELCOME.png`,
      mobileImage: `/ui/mtx/assets/Onboarding/${theme}/mobile/ON_BOARDING_WELCOME.png`,
    },
    {
      id: "watch_from_home",
      title: "onboarding.steps.home.watch.title",
      description: "onboarding.steps.home.watch.description",
      image: `/ui/mtx/assets/Onboarding/${theme}/ON_BOARDING_CLICK_ON_WATCH.png`,
      mobileImage: `/ui/mtx/assets/Onboarding/${theme}/mobile/ON_BOARDING_CLICK_ON_WATCH.png`,
    },
    {
      id: "stream_from_home",
      title: "onboarding.steps.home.stream.title",
      description: "onboarding.steps.home.stream.description",
      image: `/ui/mtx/assets/Onboarding/${theme}/ON_BOARDING_CLICK_ON_ADD.png`,
      mobileImage: `/ui/mtx/assets/Onboarding/${theme}/mobile/ON_BOARDING_CLICK_ON_ADD.png`,
    },
  ];
}

function STREAM_PAGE_ONBOARDING_STEPS(theme: string): OnboardingStep[] {
  return [
    {
      id: "stream2",
      title: "onboarding.steps.stream.stream1.title",
      description: "onboarding.steps.stream.stream1.description",
      image: `/ui/mtx/assets/Onboarding/${theme}/ON_BOARDING_START_A_STREAM.png`,
    ...
    },
    {
      ...
      image: "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_SETTINGS.png",
      mobileImage:
        "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_SETTINGS.png",
    },
    {
      id: "opentak2",
      title: "onboarding.steps.stream.opentak2.title",
      description: "onboarding.steps.stream.opentak2.description",
      image: "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_ALL_SETTINGS.png",
      mobileImage:
        "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_ALL_SETTINGS.png",
    },
    {
      id: "opentak3",
      title: "onboarding.steps.stream.opentak3.title",
      description: "onboarding.steps.stream.opentak3.description",
      image:
        "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_STREAM_SETTINGS.png",
      mobileImage:
        "/ui/mtx/assets/Onboarding/ON_BOARDING_OPEN_TAK_STREAM_SETTINGS.png",
    },
  ];
...
function WATCH_PAGE_ONBOARDING_STEPS(theme: string): OnboardingStep[] {
  return [
    {
      id: "watch2",
      title: "onboarding.steps.watch.watch1.title",
      description: "onboarding.steps.watch.watch1.description",
      image: `/ui/mtx/assets/Onboarding/${theme}/ON_BOARDING_WATCH_A_STREAM.png`,
      mobileImage: `/ui/mtx/assets/Onboarding/${theme}/mobile/ON_BOARDING_WATCH_A_STREAM.png`,
    },
  ];
}
